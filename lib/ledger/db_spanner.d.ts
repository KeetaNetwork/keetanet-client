...
export declare class DBSpanner extends LedgerStorageBase implements LedgerStorageAPI {
    ...
    listACLsByEntity(transaction: SpannerTransaction, entity: GenericAccount, options?: ListACLsByEntityFilters): Promise<ACLRow[]>;
    listACLsByPrincipal(transaction: SpannerTransaction, principal: ACLRow['principal'], entityList?: GenericAccount[]): Promise<ACLRow[]>;
